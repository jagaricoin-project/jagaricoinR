...
SIGPATH=/some/root/path/jagaricoinR-detached-sigs
...
in `gitian.sigs.jagaR` to your signing machine and do
...
[bitcoin-core/gitian.sigs.jagaR](https://github.com/bitcoin-core/gitian.sigs.jagaR/) repository, or if that's not possible create a pull
