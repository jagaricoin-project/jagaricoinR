...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jagaricoin-project/jagaricoinR>";
    const std::string URL_WEBSITE = "<http://jagaricoinR.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("JagariCoinR version %s\n", FormatFullVersion());
}
