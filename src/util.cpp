...
const char * const BITCOIN_CONF_FILENAME = "jagaricoinR.conf";
const char * const BITCOIN_PID_FILENAME = "jagaricoinR.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "JagariCoinR";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/JagariCoinR";
#else
    // Unix
    return pathRet / ".jagaricoinR";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    strCopyrightHolders += "\n" + strprintf(strPrefix, 2018, nCopyrightYear) + " The JagariCoinR Core developers";
