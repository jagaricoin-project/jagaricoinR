...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jagaricoinR-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jagaricoinR-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jagaricoinR transaction") + "\n" +
              "  jagaricoinR-tx [options] -create [commands]   " + _("Create hex-encoded jagaricoinR transaction") + "\n" +
              "\n";
